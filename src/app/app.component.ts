...
import { stateModel } from './modeloEstado';
...
export class AppComponent {
  ...
  public cogerEstado(): void {
    console.log(this.myGrid.getstate())
    let estado: stateModel = this.myGrid.getstate();
    console.log(this.myGrid.widgetObject)
    timer(5000).subscribe((data) => {
      //this.myGrid.loadstate(estado);
      //this.myGrid.filter(estado.filters)
      this.myGrid.sortby(estado.sortcolumn, (estado.sortdirection.asceding == true) ? ('asc') : ('desc'));


      //this.myGrid.columns(estado.columns);
      //this.myGrid.filter(estado.filters);
      //this.myGrid.groups(estado.groups)
